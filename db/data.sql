...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2025 a las 12:36:57
...
('Mario Level Up', 'Arcade', 'Disponible', 'Prepárate para llevar tus aventuras al siguiente nivel. Mario Level Up reinventa la fórmula clásica de plataformas con una experiencia llena de energía, desafíos vibrantes y un sistema de mejoras que transforma cada partida en algo nuevo.\r\n\r\nAcompaña a Mario a través de mundos coloridos, enemigos extravagantes y obstáculos que pondrán a prueba tu precisión y creatividad. Salta, corre, esquiva, aplasta enemigos y recolecta estrellas especiales para subir de nivel y desbloquear poderes completamente nuevos.\r\n\r\nCada mejora cambia tu forma de jugar: saltos más altos, velocidad aumentada, habilidades únicas y ataques especiales que te permiten superar zonas antes imposibles. Elegí tu estilo, potenciá a Mario a tu manera y descubrí rutas secretas, atajos ocultos y retos desbloqueables.\r\n\r\nCon controles precisos, música nostálgica y nuevas mecánicas, Mario Level Up combina lo mejor de la aventura clásica con un toque moderno lleno de sorpresas.\r\n\r\n¿Estás listo para subir de nivel?\r\n🌟 El Reino Champiñón te necesita… y esta vez, Mario llega más fuerte que nunca.', 'mario_minigames_promocional.jpg', NULL, 1, 36, 1, '2025-11-28', 'Emulador', '5.00', 'mario-banner2.jpg', 'mario_minigames_1.jpg', 'mario_minigames_2.png', 'mario_minigames_3.png', 'mario_minigames_4.png', '⭐ ¡Mario Level Up! – ¡Salta, evoluciona y conquista cada mundo!', NULL, 'mario_minigames_cover.jpg', 'Juego offline', '1 Jugador'),
('Mario vs Luigi Online', 'Arcade', 'Disponible', 'Entrá en la versión más caótica y divertida del clásico duelo entre hermanos. Mario vs Luigi Online reinventa el modo multijugador de New Super Mario Bros. con partidas frenéticas, escenarios dinámicos y enfrentamientos donde cada salto puede decidir al ganador.\r\n\r\nElegí tu personaje favorito y enfrentate a tu rival en niveles llenos de plataformas, trampas y power-ups que cambian el ritmo del juego en segundos. Saltá, esquivá, empujá, robá ítems y hacé jugadas inesperadas para ser el primero en conseguir la estrella y mantenerla el mayor tiempo posible.\r\n\r\nCada partida es distinta: nuevos obstáculos, rutas alternativas, movimientos técnicos y choques impredecibles que transforman el clásico duelo en una experiencia rápida, explosiva y llena de risas. Disfrutá batallas fluidas contra amigos o jugadores de todo el mundo, con controles precisos y la esencia única del Mario 2D de siempre.\r\n\r\n¿Listo para demostrar quién es el verdadero rey del Reino Champiñón?\r\nSolo uno puede ganar… y esta vez, el combate es personal.', 'mario_online_promocional.png', NULL, 1, 37, 1, '2025-11-28', 'Emulador', '10.00', 'mario-banner2.jpg', 'mario_online_1.png', 'mario_online_2.png', 'mario_online_3.png', 'mario_online_4.png', '¡Competí, empujá y conquistá el campo de batalla!', NULL, 'mario_online_cover.jpg', 'Juego offline', '1 - 2 Jugadores'),
('Sushi Gun', 'Arcade', 'Disponible', 'Prepárate para una explosión de sabor y caos en Sushi Gun, un arcade frenético donde enfrentás hordas de platos furiosos usando… ¡un arma que dispara sushi! Cada nivel te lanza una oleada de enemigos culinarios, obstáculos impredecibles y power-ups deliciosamente destructivos que transforman el combate en puro frenesí.\r\n\r\nEsquivá los ataques, apuntá con precisión y dispará combinaciones perfectas para crear sushis más potentes que arrasen todo a su paso. Cuanto mejor mezcles tus ingredientes, más daño hacés, desbloqueando habilidades especiales, mejoras absurdas y combos que llenan la pantalla de caos colorido.\r\n\r\nCon partidas rápidas, controles simples y una estética divertida, Sushi Gun convierte cada ronda en un desafío adictivo donde todo puede pasar. Subí de nivel, mejorá tu arma, enfrentate a platos gigantes y descubrí recetas secretas que te darán el poder necesario para sobrevivir.', 'sushigun-cover.jpg', NULL, 1, 38, 1, '2025-11-28', 'Emulador', '2.00', 'banner2-sushi.jpg', 'sushigun-2.png', 'sushigun-3.png', 'sushigun-1.png', 'sushigun-1.png', 'Sushi Gun – ¡Dispará, combiná y dominá!', NULL, 'sushigun-1.png', 'Juego offline', '1 Jugador'),
('Zombotron', 'Arcade', 'Disponible', 'En Zombotron no sos un héroe… sos simplemente alguien que llegó al lugar equivocado, en el momento exacto en el que todo se fue al infierno. El planeta está muerto, sus habitantes están podridos por una mezcla de tecnología rota y biología descontrolada, y cada pasillo es una trampa disfrazada de camino seguro.\r\n\r\nLa misión es simple: avanzar.\r\nEl problema: absolutamente todo quiere impedirlo.\r\n\r\nZombotron combina disparos explosivos, física caótica y escenarios que reaccionan a cada bala. No esperes combates limpios; acá todo se derrumba, rebota, estalla o se vuelve en tu contra. Usá el entorno para aplastar enemigos, activá mecanismos antiguos, jugá con explosiones encadenadas y sobreviví a criaturas que no saben ni de piedad ni de descanso.\r\n\r\nA medida que explores, irás encontrando armas, armaduras y mejoras que transforman tu manera de enfrentar el desastre. Nada de caminatas tranquilas: cada sala es un rompecabezas lleno de violencia, humor negro y sorpresas que no vas a ver venir.\r\n\r\nZombotron no es un paseo.\r\nEs una lucha constante contra un planeta que parece disfrutar cada vez que fallás… y que, sin embargo, te invita a intentarlo una vez más.', 'img3-zombotron.jpg', NULL, 1, 39, 1, '2025-11-28', 'Emulador', '2.00', 'GunMission-Banner2.jpg', 'img1-zombotron.jpg', 'img4-zombotron.jpg', 'img3-zombotron.jpg', 'img5-zombotron.jpg', 'Caos mecánico, criaturas mutantes y un planeta que quiere verte caer', NULL, 'portada-zombotron.jpg', 'Juego offline', '1 Jugador'),
('Decade Castle', 'Arcade', 'Disponible', 'Una extraña distorsión temporal está desgarrando el Castillo de la Década, y el rey te ha confiado la misión más peligrosa: viajar a través del tiempo para romper la maldición que consume sus muros. Cada Time Warp te arroja diez años hacia el futuro, transformando el entorno, desgastando la arquitectura y volviendo más feroces —y extrañas— a las criaturas que lo habitan.\r\n\r\nExplorarás salas que se derrumban, jardines que envejecen ante tus ojos y enemigos que mutan con cada salto temporal. Para avanzar, deberás usar tus herramientas, habilidades y Time Warps de forma estratégica, eligiendo cuándo retroceder, cuándo avanzar y cuándo enfrentar el inevitable deterioro del castillo.\r\n\r\nCada década trae nuevos peligros…\r\ny nuevas oportunidades.\r\n\r\nRecolectá recursos, resolvé acertijos distorsionados por el paso del tiempo y descubrí los secretos del castillo antes de que colapse por completo. Solo alguien capaz de dominar las líneas temporales podrá liberar al reino de su destino.\r\n\r\n¿Podrás conquistar un castillo que cambia más rápido de lo que podés correr?', 'decade-castle-cover.png', NULL, 1, 40, 1, '2025-11-28', 'Emulador', '5.00', 'mario-banner2.jpg', 'decade-castle-1.png', 'decade-castle-2.png', 'decade-castle-3.png', 'decade-castle-4.png', '🏰 Decade Castle – La Batalla por el Castillo Eterno', NULL, 'DC-Cover.png', 'Juego offline', '1 Jugador'),
('Exhibit of sorrows', 'Arcade', 'Disponible', 'Bienvenido al Exhibit of Sorrows, un museo-circo lleno de colores falsos, sonrisas dibujadas y marionetas que parecen demasiado vivas para tu tranquilidad. Al principio, todo parece un espectáculo extraño pero inofensivo: botones que reaccionan, juguetes que se presentan con una amabilidad casi exagerada, y una atmósfera infantil que te invita a seguir avanzando.\r\n\r\nPero los juguetes no están ahí para entretenerte.\r\nEstán esperando que sigas las reglas… las suyas.\r\n\r\nA medida que explorás cada sala, el ambiente se va deformando: las luces se vuelven más opacas, la música deja de sonar como un juego y las marionetas empiezan a pedirte cosas que no suenan del todo correctas. Cada interacción te obliga a acercarte más de lo que querrías, y cada “tarea” te empuja un poco más hacia ese punto donde el circo deja de ser un lugar divertido.\r\n\r\nEl único camino es hacia adelante.\r\nY cada paso te recuerda que las risas pueden esconder algo mucho más oscuro.\r\n\r\nDescubrí qué ocurrió con las marionetas, enfrentate a los trucos que esconden sus sonrisas demasiado amplias y encontrá la forma de salir antes de convertirte en parte permanente de la exhibición.\r\n\r\nEn Exhibit of Sorrows, la pregunta no es qué te están mostrando…\r\nsino por qué quieren que lo veas.', 'exhibit-banner1.jpg', NULL, 1, 41, 1, '2025-11-28', 'Emulador', '5.00', 'exhibit-banner2.jpg', 'exhibit _of_sorrows_1.png', 'exhibit _of_sorrows_2.png', 'exhibit _of_sorrows_3.png', 'exhibit _of_sorrows_4.png', 'La risa se siente distinta cuando estás atrapado', NULL, 'Exhibit-cover.jpg', 'Juego offline', '1 Jugador');
...
('a', 'amydelgado88@gmail.com', 'a', 1, 'creator', 'a', '1_1762267798.png', '1900-01-17', '', 219, 14),
...
(1, 27, '2025-11-28 07:39:11', 1),
(1, 31, '2025-11-25 13:28:25', 1),
(1, 32, '2025-11-28 07:39:11', 1),
(1, 34, '2025-11-28 07:39:11', 1),
...
--
ALTER TABLE `game`
  MODIFY `idGame` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

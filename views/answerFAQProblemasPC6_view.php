...
<body>
    <main id="mainSoporteAns">
        <section id="soporteAns">
            <p><a href="support.php">Soporte Tecnico</a> / ¿Dónde puedo encontrar las partidas guardadas locales?</p>
        </section>

        <section class="respuesta">
            <h1>¿Dónde puedo encontrar las partidas guardadas locales?</h1>

            <p>Si quieres hacer una copia de una partida guardada local:</p>
            ...
            <p>Es posible que los archivos guardados de algunos juegos se almacenen en otra carpeta. <br>Estas son algunas de las ubicaciones frecuentes donde pueden estar las partidas guardadas:</p>

            <ul>
                <li>%USERPROFILE%DocumentsMy Games</li>
                <li>%USERPROFILE%AppDataLocalLow</li>
                <li>%USERPROFILE%Documents</li>
                <li>savegames</li>
                <li>%APPDATA%Ubisoft</li>
                <li>%LOCALAPPDATA%</li>
                <li>%USERPROFILE%Saved Games</li>
                <li>%APPDATA%</li>
            </ul>

            <p>Si aún no puedes encontrar la partida guardada, contacta al desarrollador del juego para saber dónde puede estar el archivo guardado.</p>

...
<body>
    <main id="mainComunidad">
        ...
        <section id="publicaciones"><?php if (empty($publications_list)): ?>
                <p style="text-align: center; padding: 20px; color: #888;">No hay publicaciones en la comunidad para este
                    juego todavía.</p>
            <?php endif; ?>
                ...
                <a class="publicacion" href="<?php echo $publication_link; ?>">
                    <div id="imgUsComunidad">
                        <img src="<?php echo $profile_img_path; ?>"
                            alt="Imagen de perfil de <?php echo htmlspecialchars($publication['user_name']); ?>">
                    ...
                    <div class="contenido">
                        ...
                        <div class="interacciones" data-id="<?php echo (int) $publication['idPublication']; ?>">
                            <p class="btn-like" data-type="like">
                                <i class="bi bi-hand-thumbs-up"></i> <span><?php echo (int) $publication['likes']; ?></span>
                            </p>

                            <p class="btn-dislike" data-type="dislike">
                                <i class="bi bi-hand-thumbs-down"></i>
                                <span><?php echo (int) $publication['dislikes']; ?></span>
                            </p>

                            <p>
                                <i class="bi bi-chat"></i> <span><?php echo $comments_count; ?></span>
                            </p>
                        </div>
                    </div>
                </a>

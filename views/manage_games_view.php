    ...
    <main id="mainGestion">
        <div>
            ...
            <?php if (isset($idGame_edicion) && $idGame_edicion): ?>
                ...
                <a href="manage_games.php" class="acciones volverListado">←
                ...
                <div class="form-container">
                    ...
                    <form method="POST" action="manage_games.php">
                        ...
                        <button type="submit" class="btn azul botonmargin"><?php echo $edition_a_editar ? 'Actualizar Edición' : 'Crear Edición'; ?></button>
                            ...
                            <li class="edition-card">
                                ...
                                <div class="acciones">
                                    ...
                                    <form method="POST" action="manage_games.php" style="display: inline-block; margin-left: 10px;"
                                        ...
                                        <button type="submit" class="btn azul">Eliminar</button>
                                    </form>
                                </div>
                            </li>
                        <?php endforeach; ?>
            ...
            <?php elseif ($juego_a_editar): ?>
                ...
                <a class="volverListado" href="manage_games.php">← Volver al Listado de Juegos</a>
                ...
                <div class="form-container">
                    ...
                    <form method="POST" action="manage_games.php" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn azul botonmargin">Actualizar Datos del Juego</button>
                    </form>
                </div>
                ...
                <div class="form-container">
                    ...
                    <form method="POST" action="manage_games.php" enctype="multipart/form-data">
                        ...
                        <label for="image_field_to_update" class="campo">Campo de Imagen a Reemplazar:</label>
                        ...
                        <div class="fileBox">
                            <label class="violetaClaro" for="game_image">Seleccionar Nueva Imagen</label>
                            <input type="file" id="game_image" name="game_image" accept="image/*" required>
                        </div>

                        <button type="submit" class="btn azul">Actualizar Imagen</button>
                    </form>
                </div>

...
<body>
    <main id="mainSoporteAns">
        <section id="soporteAns">
            <p><a href="support.php">Soporte Tecnico</a> / Cómo mantener la sesión iniciada en la página web</p>
        </section>

        <section class="respuesta">
            <h1>Cómo mantener la sesión iniciada en la página web</h1>

            <p>Activa la opción “Recordarme” al iniciar sesión. Si el problema persiste, contacta a <a href="">soporte@digitalnight.com <i class="bi bi-arrow-up-right"></i></a></p>
